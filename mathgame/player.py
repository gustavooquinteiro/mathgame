    ...
    def shoot(self):
        if isinstance(self.level, Level_04):
            if self.direction is "R":
                facing = 1
                self.bullets.append(Projectile(round(self.rect.x + 65), round(self.rect.y + 55), 6*self.power, GREEN, facing, self.power))
            else:
                facing = -1
                self.bullets.append(Projectile(round(self.rect.x - 10), round(self.rect.y + 55), 6*self.power, GREEN, facing, self.power))
